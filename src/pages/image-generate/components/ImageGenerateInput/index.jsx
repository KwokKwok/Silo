...
import ModelChoose from './ModelSelect/index';
import { useLocalStorageJSONAtom } from '@src/store/storage';
import { getImageGenerateOptions } from '@src/utils/options/image-options';
import { Tag } from 'tdesign-react';
import { useIsMobile } from '@src/utils/use';
import DrawPlaceholder from '@src/assets/img/draw.svg';
...
function ImageInput({
  ...
  const activeImageModels = _activeImageModels.filter(item =>
    availableImageModelIds.includes(item)
  );
